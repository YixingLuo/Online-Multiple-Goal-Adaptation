...
x1 = [data1_1(:,1)/1e6,data2_1(:,1)/1e6,data3_1(:,1)/1e6];
x2 = [data1_1(:,2)/1e6,data2_1(:,2)/1e6,data3_1(:,2)/1e6];
x3 = [data1_1(:,3)/1e6,data2_1(:,3)/1e6,data3_1(:,3)/1e6];
x4 = [data1_1(:,4)/1e6,data2_1(:,4)/1e6,data3_1(:,4)/1e6];
x5 = [data1_1(:,5)/1e6,data2_1(:,5)/1e6,data3_1(:,5)/1e6];
x6 = [data1_1(:,6)/1e6,data2_1(:,6)/1e6,data3_1(:,6)/1e6];

...
% clear
% num = 1;
function [data, trajectory,velocity_history,planning_time] = uav_relaxation(num)
global env
global env_known
global configure
global eplison
...
%           end  
    ...
    if fval > eplison
       ...
       [safety_variance, safety_ratio, privacy_variance, privacy_ratio, info_variance, info_ratio, time_variance, time_ratio, energy_variance, energy_ratio] = goal_relaxation(x);

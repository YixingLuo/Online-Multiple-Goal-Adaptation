...
% f = f + ((energy_now - configure.battery_target)/(configure.battery_budget-configure.battery_target)).^2;
% f = f + ((time_now -  configure.Time_target)/(configure.Time_budget-configure.Time_target)).^2;
% 
% if bound_o > 0
%     f = f + (SR/bound_o).^2;
% end

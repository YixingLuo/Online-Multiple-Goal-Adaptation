...
%     following_point, following_plan
    ...
    if current_point(1) == end_point(1) && current_point(2) == end_point(2) && current_point(3) == end_point(3)
        ...
        [SR, DS_SR, PR, DS_PR, DS_acc] = goal_checking(trajectory, env);
...
%         exitflag
        if exitflag > 0
%             [safety_variance, safety_ratio, privacy_variance, privacy_ratio, info_variance, info_ratio, time_variance, time_ratio, energy_variance, energy_ratio] = goal_checking(x);

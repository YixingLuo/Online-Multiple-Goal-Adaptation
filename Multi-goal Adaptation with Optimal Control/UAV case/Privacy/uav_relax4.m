...
% clear
% num = 1;
function [data, trajectory,velocity_history,planning_time] = uav_relax4(num)
global env
global env_known
global configure
configure = Configure();
...
%         options.MaxFunEvals = 100000;
        [x,fval,exitflag,output,lambda]=fmincon(@objuav_relax4,x0,[],[],[],[],lb,ub,@myconuav_relax4,options);

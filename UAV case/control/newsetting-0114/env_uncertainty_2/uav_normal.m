...
% num_condition = 14;
% indextemp = [4,12,22];
function [data, trajectory,velocity_history,planning_time] = uav_normal(num_map)
global env
global env_known
global configure
global ratio
...
%         name1 = 'planningtime_normal.mat';
%         save(name1, 'planning_time');
%         name2 = 'trajectory_normal.mat';
%         save(name2, 'trajectory');
%         name3 = 'velocity_history_normal.mat';

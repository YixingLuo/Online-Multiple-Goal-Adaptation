...
temp_f = x(end-(bound_o + bound_p + 3))/(configure.battery_budget-configure.battery_target) + x(end-(bound_o + bound_p + 3)-1)/(configure.Time_budget-configure.Time_target) + x(end-(bound_o + bound_p + 3)-2)/(configure.forensic_target-configure.forensic_budget);

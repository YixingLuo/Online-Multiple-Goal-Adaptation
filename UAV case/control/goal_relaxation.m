function [safety_variance, safety_ratio, privacy_variance, privacy_ratio, info_variance, info_ratio, time_variance, time_ratio, energy_variance, energy_ratio] = goal_relaxation(x)
...
%     safety_variance, configure.obstacle_max, bound_o
end
if bound_p > 0
